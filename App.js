import React, {useState} from 'react' //useState ´r um hook para gerenciar os estados
...
export default function App(){
  ...
  function falar(){
    let frase = frases[parseInt(Math.random() * frases.lenght)]
    Speech.speak(frase, {
      language: 'pt',
      onStart: iniciaFala,
      onDone: finalizaFala
  ...
  return(
    <SafeAreaView style={styles.Principal}>
      <Text style={styles.Titulo}>
        <FontAwesome name="comment-o" size={40}/>Fala Verissimo!{falando}
        </Text>
